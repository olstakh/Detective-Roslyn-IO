        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetRepoUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ExpectedAnswer = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    AnswerFormat = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    CaseSensitive = table.Column<bool>(type: "INTEGER", nullable: false),
                    RoslynDocsUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProgress_IsCompleted",
                table: "UserProgress",
                column: "IsCompleted");

            migrationBuilder.CreateIndex(
                name: "IX_UserProgress_UserId_ChallengeId",
                table: "UserProgress",
